...
$evento = new Evento();
$evento->pesquisaEvento("id_evento",$_GET["id_evento"]);
?>
<h2>Novo Evento</h2>
	...
	<hr/>	<!-- linha de separação -->
		...
		<div class="row">
			<div class="form-group col-md-4">
				...
				<input type="date" class="form-control" name="inicio" value="<?php echo $evento ->getInicio();?>" required>
			</div>
			<div class="form-group col-md-4">
				<label for="nome">Data final:</label>
				<input type="date" class="form-control"  name="final" value="<?php echo $evento ->getFinal();?>">
			</div>
		</div>
